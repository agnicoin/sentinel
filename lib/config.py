...
sentinel_cfg = AgniConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_agnid_proto_version_with_sentinel_ping = 70207


def get_agni_conf():
    home = os.environ.get('HOME')

    agni_conf = os.path.join(home, ".agnicore/agni.conf")
    if sys.platform == 'darwin':
        agni_conf = os.path.join(home, "Library/Application Support/AgniCore/agni.conf")

    agni_conf = sentinel_cfg.get('agni_conf', agni_conf)
