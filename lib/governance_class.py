...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to agnid "gobject list" output
    ...
    def agnid_serialise(self):
        import agnilib
        return agnilib.SHIM_serialise_for_agnid(self.serialise())
